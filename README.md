...
Optional secondmates extend this to persistent local or whole-home remote second mates, and dispatch profiles let you steer which harness handles which task.
...
- [docs/docker.md](docs/docker.md) - run the fleet in a sealed container with no host access and a default-deny egress allowlist.
